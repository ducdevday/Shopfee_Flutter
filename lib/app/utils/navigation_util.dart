...
class NavigationUtil {
  ...
  static Future pushAndRemoveUntil({required Widget page}) async {
    return await _navigatorKey?.pushAndRemoveUntil(MaterialPageRoute(builder: (_) => page), (route) => false);
  }

  static Future pushReplacement({required Widget page}) async {
    return await _navigatorKey?.pushReplacement(MaterialPageRoute(builder: (_) => page));
  }
