...
class ProductByCategoryIdScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: BlocBuilder<ProductByCategoryIdBloc, ProductByCategoryIdState>(
                    ...
                    Row(
                      ...
                      children: [
                        IconButton(
                            ...
                            icon: Icon(Icons.menu, color: state.viewType == ViewType.List_View ? AppColor.primaryColor : AppColor.disableColor,)),
                        IconButton(
                            splashColor: Colors.transparent,
                            highlightColor: Colors.transparent,
                            onPressed: () {
                            ...
                            icon: Icon(Icons.grid_view_sharp, color: state.viewType == ViewType.Grid_View ? AppColor.primaryColor : AppColor.disableColor))
                      ],
                    ),
                    ProductList(context, state),
                    SizedBox(
                      height: 56,
                    )
                  ],
